...
"""
    ...
    def _setup_menu(self):
        ...
        lang_menu.addAction("简体中文 (Chinese Simplified)", lambda: self.switch_language("zh-CN"))
        lang_menu.addAction("繁體中文 (Chinese Traditional)", lambda: self.switch_language("zh-TW"))
        lang_menu.addAction("한국어 (Korean)", lambda: self.switch_language("ko"))
        lang_menu.addAction("Español (Spanish)", lambda: self.switch_language("es"))
        lang_menu.addAction("Português (Portuguese)", lambda: self.switch_language("pt"))
        lang_menu.addAction("Français (French)", lambda: self.switch_language("fr"))
        lang_menu.addAction("Deutsch (German)", lambda: self.switch_language("de"))
        lang_menu.addAction("ภาษาไทย (Thai)", lambda: self.switch_language("th"))
        lang_menu.addAction("Tiếng Việt (Vietnamese)", lambda: self.switch_language("vi"))
        lang_menu.addAction("Русский (Russian)", lambda: self.switch_language("ru"))
        lang_menu.addAction("العربية (Arabic)", lambda: self.switch_language("ar"))
        lang_menu.addAction("Bahasa Melayu (Malay)", lambda: self.switch_language("ms"))
