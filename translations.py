...
TRANSLATIONS = {
    ...
    "ja": {
        ...
        "tab_bg": "背景削除",
        "tab_up": "高画質化",
        "lbl_loaded_bg": "読み込み済み画像 (背景削除):",
        "lbl_loaded_up": "読み込み済み画像 (高画質化):",
        "btn_add": "画像を追加…",
        "btn_clear": "リストをクリア",
        "lbl_out": "出力フォルダ:",
        "btn_change": "フォルダ変更",
        "btn_proc_sel": "処理開始 (選択のみ)",
        "btn_proc_all": "処理開始 (すべて)",
        "lbl_model": "モデル:",
        "lbl_scale": "拡大率:",
        "lbl_sens": "感度:",
        "msg_done": "完了",
    ...
    "id": {
        ...
        "menu_plugins": "Plugin",
        "tab_bg": "Hapus Background",
        "tab_up": "Upscaler",
        "lbl_loaded_bg": "GAMBAR DIMUAT (Hapus BG):",
        "lbl_loaded_up": "GAMBAR DIMUAT (Upscaler):",
        "btn_add": "Tambah Gambar…",
        "btn_clear": "Bersihkan List",
        "lbl_out": "Folder Output:",
        "btn_change": "Ubah Folder",
        ...
        "msg_done": "Selesai",
        "msg_error": "Error",
        "msg_select": "Pilih gambar dulu.",
        "msg_add": "Tambah gambar dulu.",
        "lbl_loaded": "GAMBAR DIMUAT:",
        "btn_close_img": "Tutup Gambar",
        "btn_save": "Simpan",
        "btn_open": "Buka Gambar",
        "dfx_palette": "Palet:",
        "dfx_mode": "Mode Dither:",
        "dfx_strength": "Kekuatan Piksel:",
        "dfx_bloom": "Bloom / Cahaya:",
        "dfx_pre": "Pra-Proses:",
